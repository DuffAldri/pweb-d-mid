    ...
    <div id="<?php echo e($k->slug); ?>" class="row justify-content-center align-content-center">
        ...
        <div class="col-lg-6 m-3 d-flex align-items-center">
            <div class="col">
                ...
                <p class="fs-5"><?php echo e($k->price); ?></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Daffa's File SSD\WebDev\pweb-mid\resources\views/catalog.blade.php ENDPATH**/ ?>