    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-6 row-content">
                {{-- <p class="lead fs-4">Muhammad Daffa Aldriantama | 5025201177</p> --}}
                <h1 class="fw-bold display-1-sm">Cari kos?<br><span class="first-color">DAKos</span> aja!</h1>
                <p class="fs-4">
                    Di sini, kamu dapat mencari kos dengan harga termurah!
                </p>
                <a class="btn rounded-pill btn-rounded text-white" style="background-color:#345cb3;"href="@auth {{ route('catalog') }} @endauth @guest {{ route('login') }} @endguest">Lihat Kos! ></a>
            </div>
            <div class="col-md-6">
